...
# Quasi Rees neighbor designs for block of equal size.
################################################################################
...
minimal CQRNDs for", "v=" ,object[[3]][1], "and","k=",object[[3]][2], "\n")
...
###################################################################
# H is an output object from CQRNDs_equalsize
...
################################################################################
# Examples: Using CQRNDs2_equalsize function to obtain the set(s) of shifts
# for construction of Circular Quasi Rees neighbor design for equal block  
# sizes (k)
################################################################################


# example#1
(H<-CGN2_equalsize(k=4,i=2))
(D<-design(H))
