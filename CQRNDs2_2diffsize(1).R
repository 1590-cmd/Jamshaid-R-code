...
################################################################################
# CQRNDs2_2diffsize: Circular Generalized neighbor design for block of two different
# sizes.
...
# Balanced Neighbor Designs through Circular QRNDs2 -designs Generated with R. 
...
# Quasi Rees neighbor design for block of two different
# sizes 
################################################################################
...
###############################################################################
# Examples: Using CQRNDs_2diffsize function to obtain the set(s) of shifts
...
# Example#1
(H<-CGN2_2diffsize(k=c(4,3),i=1,D=1))
(design(H))

# Example#2
(H<-CGN2_2diffsize(k=c(10,7),i=1,D=2)) 
(design(H))
